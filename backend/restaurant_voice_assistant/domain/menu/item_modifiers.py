"""Menu item modifier linking domain service.

This module provides business logic for managing many-to-many relationships
between menu items and modifiers. It handles linking, unlinking, and querying
modifier associations.

Key Features:
    - Many-to-many relationship management
    - Required/optional modifier support
    - Display order management
    - Validation of restaurant ownership

Relationship Structure:
    - menu_items ←→ menu_item_modifiers ←→ modifiers
    - Junction table: menu_item_modifiers (id, menu_item_id, modifier_id, is_required, display_order)
...
def unlink_modifier_from_item(
    ...
    Raises:
        ValueError: If menu item doesn't belong to restaurant
...
def get_modifiers_for_item(
    ...
    Returns:
        List of linked modifiers with full details including link metadata
