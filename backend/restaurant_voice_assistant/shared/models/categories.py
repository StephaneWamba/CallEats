...
This module defines request and response models for menu category management endpoints.
Categories organize menu items and support display ordering for UI presentation.

Models:
    - CategoryResponse: Response model with category data
...
Validation:
    ...
    - Display order controls UI sorting (lower numbers first)
...
Usage:
    ...
    request = CreateCategoryRequest(name="Appetizers", display_order=0)
"""
