"""
Service for handling Vapi knowledge base tool calls.

Processes function tool requests and returns search results.
"""
...
from src.services.phones.extraction import extract_restaurant_id_with_fallback
import asyncio
import logging
