-- Migration: 002 - Phone Number Mappings
-- Adds table for mapping phone numbers to restaurants for multi-tenant call routing
-- This enables a shared Vapi assistant instance while routing calls to correct restaurants
