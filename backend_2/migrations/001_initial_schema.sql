...
-- Creates the core database schema with extensions, tables, functions, and RLS policies
-- This is the foundation for the Restaurant Voice Assistant multi-tenant system
...
CREATE TABLE IF NOT EXISTS menu_items (
    ...
    category TEXT DEFAULT 'General', -- Legacy field for backward compatibility
...
-- Menu item to modifier junction table (many-to-many)
...
ON menu_item_modifiers FOR ALL TO service_role USING (true) WITH CHECK (true);
