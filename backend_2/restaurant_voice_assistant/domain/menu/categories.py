...
This module provides business logic for menu category management including:
    - Category CRUD operations
    - Display order management
    - Name uniqueness validation per restaurant
    - Cache invalidation on changes

Key Features:
    - Restaurant-scoped category names (unique per restaurant)
    - Display order for UI sorting
    - Automatic cache invalidation (affects menu items)
...
@invalidate_cache(category="menu")  # Categories affect menu items
def create_category(
    restaurant_id: str,
    name: str,
