...
This module provides health check functions for external dependencies.
These functions are used by the health API router to check service connectivity.

Note:
    This module is separate from the router to allow reuse in other contexts.
"""
